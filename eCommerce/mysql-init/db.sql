...
-- Create the Products table (plural to match the expected name)
...
INSERT INTO products (ProductID, ProductName, Category, UnitPrice, QuantityInStock) VALUES
  ...
  ('6a14f510-72c1-42c8-9a5a-8ef8f3f45a0d', 'Running Shoes', 'Clothing', 49.99, 75),
  ...
  ('12b369b7-9101-41b1-a653-6c6c9a4fe1e4', 'Breville Smart Blender', 'Home Appliances', 129.99, 50);
