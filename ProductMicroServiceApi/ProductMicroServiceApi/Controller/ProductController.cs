...
namespace ProductMicroServiceApi.Controller
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        {
            List<ProductResponse?> ProductsByName = await _ProductService
                .GetProductsByCondition(temp => temp.ProductName != null && temp.ProductName
                .Contains(SearchString, StringComparison.OrdinalIgnoreCase));
            List<ProductResponse?> ProductByCategory = await _ProductService
                .GetProductsByCondition(temp => temp.Category != null && temp.Category
                .Contains(SearchString, StringComparison.OrdinalIgnoreCase));
